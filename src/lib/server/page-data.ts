...
export async function getDashboardDataForPage(search?: { range?: string | null; line?: string | null; lines?: MetroLine[] | null; carSeries?: number[] | null }) {
  ...
  return getReportsForDashboard({ range, lines, carSeries: search?.carSeries });
}
