export const messages = {
  ...
  explore: {
    ...
    fleetAdjustedScoreHelp:
      "Formula: min(100, base indicator × (1 + cars reported as Hot/Hell ÷ estimated cars on the line)). It rises when heat appears across more of that line's fleet.",
    ...
    fleetAdjustedScoreLabel: "Fleet-adjusted indicator",
    ...
    chartTakeaways: {
      ...
      lineEvolution: "The indicator rises when affected cars cover more of the line's estimated fleet",
