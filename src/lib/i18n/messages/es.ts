export const messages = {
  ...
  methodology: {
    ...
    confidenceBody: "La confianza se calcula sobre los reportes visibles del rango seleccionado. No intenta decidir si una persona tiene razón o no: solo mide si hay suficiente señal reciente y si los reportes coinciden entre sí.",
    confidenceRules: [
      "Si hay menos de 3 reportes, la confianza es baja.",
      "Si hay 10 o más reportes y al menos el 70% coincide con el estado dominante, la confianza es alta.",
      "Si hay 5 o más reportes y al menos el 55% coincide con el estado dominante, la confianza es media.",
      "En cualquier otro caso, la confianza es baja.",
    ],
    confidenceFormulas: [
      "acuerdo = max(reportes_por_estado) / total_reportes",
