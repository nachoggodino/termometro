export const messages = {
  ...
  explore: {
    ...
    fleetAdjustedScoreHelp:
      "Fórmula: min(100, indicador base × (1 + coches reportados en Calor/Infierno ÷ flota estimada de la línea)). Sube cuando el calor aparece en más coches de esa flota.",
    ...
    fleetAdjustedScoreLabel: "Indicador ajustado por flota",
    ...
    chartTakeaways: {
      ...
      lineEvolution: "El indicador sube si más coches afectados aparecen dentro de la flota estimada de esa línea",
