export const messages = {
  ...
  methodology: {
    ...
    scoreBody: "El Indicador Termo va de 0 a 100 y se calcula con reportes acumulados del verano. Cada reporte pesa menos con el tiempo: su peso se reduce a la mitad cada 3 días. Primero se calcula el calor medio ponderado, después una presión de reportes que se satura con el volumen, y una cobertura de flota que cuenta cada coche una sola vez usando su reporte más reciente o fuerte. El resultado final multiplica el calor medio por una mezcla de 65% presión de reportes y 35% cobertura de flota. Así, reportes calientes recientes suben el indicador, reportes antiguos pierden fuerza y nuevos reportes frescos pueden bajarlo aunque aumente el total de reportes",
